...
def clean_module_code(content: str) -> str:
    ...
    for line in lines:
        ...
        if stripped.startswith("from __future__ import"):
            continue
        if re.match(r"^from watson_\w+ import", stripped) or re.match(r"^import watson_\w+", stripped):
            continue
